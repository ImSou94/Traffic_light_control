...
#inititalising the Count
#Because of the low processing speed of raspberry pi faced difficulty in timing algorithm
#So started a new thread for just the timer
a=1
b=1
c=1
d=1
